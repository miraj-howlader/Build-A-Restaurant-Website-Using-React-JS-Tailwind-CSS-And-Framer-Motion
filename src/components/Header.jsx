...
const Header = () => {
  ...
  animate={isActive ?"show":''}
   className=' fixed w-full max-w-[1900px] z-50 py-4'>
    <motion.div
      ...
      <div className='flex justify-between items-center px-4
       lg:px-0 relative text-white'>
        ...
        className={`${nav?"gap-y-0":"gap-y-2"} flex flex-col items-center
         justify-center w-12 h-12 p-3 order-2 lg:order-none
        ...
        initial='hidden'
        animate={nav?'show':""}
         className=' absolute bg-accent w-[310px] h-[60vh]
         right-0 lg:left-0 top-[120px] bottom-0 z-50 rounded-lg
          shadow-xl'>
          <Nav />
        </motion.div>
